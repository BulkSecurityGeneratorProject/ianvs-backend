...
import com.toseanalytica.ianvs.repository.BranchRepository;
...
public class BranchResourceIntTest {
    ...
    public void createBranch() throws Exception {
        ...
        assertThat(testBranch.getStreet()).isEqualTo(DEFAULT_STREET);
        assertThat(testBranch.getEmail()).isEqualTo(DEFAULT_EMAIL);
        assertThat(testBranch.getMobile()).isEqualTo(DEFAULT_MOBILE);
        assertThat(testBranch.getRegistrationDate()).isEqualTo(DEFAULT_REGISTRATION_DATE);
    }
    ...
    public void updateBranch() throws Exception {
        ...
        assertThat(testBranch.getStreet()).isEqualTo(UPDATED_STREET);
        assertThat(testBranch.getEmail()).isEqualTo(UPDATED_EMAIL);
        assertThat(testBranch.getMobile()).isEqualTo(UPDATED_MOBILE);
        assertThat(testBranch.getRegistrationDate()).isEqualTo(UPDATED_REGISTRATION_DATE);
    }
