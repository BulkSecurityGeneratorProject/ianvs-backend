...
import com.toseanalytica.ianvs.repository.ProvinceRepository;
...
public class ProvinceResourceIntTest {
    ...
    public void createProvince() throws Exception {
        ...
        assertThat(testProvince.getProvince()).isEqualTo(DEFAULT_PROVINCE);
    }
    ...
    public void updateProvince() throws Exception {
        ...
        Province testProvince = provinceList.get(provinceList.size() - 1);
        assertThat(testProvince.getProvince()).isEqualTo(UPDATED_PROVINCE);
    }
